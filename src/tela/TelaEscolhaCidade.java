...
public class TelaEscolhaCidade extends javax.swing.JDialog {
    ...
    private void btnPesquisarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnPesquisarActionPerformed
        if(!txtNome.getText().trim().isEmpty()){
            listCidade = daoC.listByEstado(estado.getId(), txtNome.getText().trim());        
            updateTable();
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TelaEscolhaCidade.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                TelaEscolhaCidade dialog = new TelaEscolhaCidade(new javax.swing.JFrame(), true);
